...
bcftools view -H ./pmdv/${f}"_pmdv.vcf.gz" | awk -F'\t' '{ if ($2 < 6498) $2=$2+152300000; else if ($2 >= 6498) $2=$2+152299028} 1' OFS='\t'  > temp_vcf.txt
cat temp_header.txt temp_vcf.txt | bcftools sort - | perl -pe 's/FLG_hg38_11rep_5526_6497/chr1/g' > ./liftover/${f}_pmdv_lift.vcf
